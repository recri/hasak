...
proc jsformat-all {values} {
    ...
    return [concat $kyr $kyrn $kyrc $kyrp $kyrv]; # leave off $prop $nrpn cross refs
}
...
proc jsoninc {values} {
    ...
    return "// parameter map for hasak $v generated by \"hasak/scripts/nrpn.tcl output json-in-c\" from hasak/config.h
// do not edit
