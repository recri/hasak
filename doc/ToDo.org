...
[ ] make output notes configurable
[ ] give voices their own notes
[ ] use a logarithmic ramp for volumes
[ ] make pot pins configurable.
[ ] implement echo all
