...
[x] Figure out how to detect the headset switches.
	...
	Need to debounce
[ ] Move headset switch adc readings into NRPN values
...
[ ] add Snooze library, hibernate on inactivity, wake on paddles.
	...
	Currently conflicts with EEPROM write.
...
[ ] Echo parameter set to MIDI to synchronize Ctrlr.
	A program dump.
...
[ ] Allow IQ to route to line-out to key a softrock.
