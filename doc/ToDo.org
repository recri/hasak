...
[ ] define NRPN_QUERY so it can read out notes, ctrls, and nrpns.
[ ] move NRPN_ACTIVE_ST into the attic.
[ ] move the morse code table into flash.
...
[ ] decide why initial probe is not seeing ID_DEVICE and VERSION.
